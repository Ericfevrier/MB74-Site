...
export function NotFound() {
  const t = usePageContent('notfound');
  return (
    <section className="min-h-[70dvh] flex items-center justify-center bg-brand-dark text-white px-4 py-14 sm:py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-xl">
        ...
        <p className="text-brand-cyan font-bold uppercase tracking-[0.3em] text-sm mb-4">{t('eyebrow')}</p>
