    ...
    <div className="bg-brand-light min-h-dvh text-gray-700 selection:bg-brand-cyan selection:text-brand-dark">
      ...
      <section className="relative min-h-[calc(100svh-80px)] lg:min-h-[calc(100svh-120px)] flex items-center justify-center pt-8 pb-10 overflow-hidden bg-brand-dark">
        <div className="absolute inset-0 z-0">
          <img src={t('hero.image')} alt="Transport de bateau en France et en Europe par Motor Boat 74" className="w-full h-full object-cover opacity-60 scale-105" referrerPolicy="no-referrer" fetchPriority="high" />
