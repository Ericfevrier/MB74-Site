    ...
    <div className="bg-brand-light min-h-dvh text-gray-700 selection:bg-brand-cyan selection:text-brand-dark">
      ...
      <section className="relative min-h-[calc(100svh-80px)] lg:min-h-[calc(100svh-120px)] flex items-center justify-center pt-8 pb-10 overflow-hidden bg-brand-dark">
        <div className="absolute inset-0 z-0">
          <img src={t('hero.image')} alt="Remorques de bateau sur mesure par Motor Boat 74 en Haute-Savoie" className="w-full h-full object-cover opacity-60 scale-105" referrerPolicy="no-referrer" fetchPriority="high" />
      ...
      <section className="py-14 sm:py-24 bg-transparent border-t border-gray-200 relative z-10">
        <div className="container mx-auto px-4 lg:px-8 max-w-[1400px]">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            {/* Formulaire */}
            <aside ref={formRef} className="lg:col-span-1 lg:sticky lg:top-32 lg:max-h-[calc(100dvh-9rem)] lg:overflow-y-auto hide-scrollbar bg-white border border-gray-200 ring-1 ring-black/[0.03] rounded-3xl p-8 shadow-xl shadow-gray-400/10">
