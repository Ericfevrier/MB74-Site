...
export const brandsData: Record<string, BrandData> = {
  ...
  mastercraft: {
    ...
    heroImage: "https://mastercraft.com/media/0zpbp3rq/xstar.webp",
    ...
    models: [
      { name: "XStar 23", image: "https://mastercraft.com/media/toqfdw11/xstar23_26_front_hero-2-1.webp", description: "Le fleuron luxe de MasterCraft : proue pickle-fork iconique, vagues de classe mondiale (SurfStar) et finitions premium. Jusqu'à 16 personnes." },
      { name: "XStar 25", image: "https://mastercraft.com/media/245lnyme/xstar25_26_front_hero.webp", description: "La version XL du fleuron : 18 places, coque affinée et stern thruster pour une maniabilité totale (rotation 360°)." },
      { name: "X24", image: "https://mastercraft.com/media/uszo0uud/x24_26_quarter_dab_hero-3.webp", description: "Le plus grand des X : espace maximal, ballast renforcé (4 050 lbs) pour des vagues puissantes. Jusqu'à 17 personnes." },
      { name: "X23", image: "https://mastercraft.com/media/l42bw2pd/x23-quarter.webp", description: "Le X au volume intérieur accru : assises plus profondes et rangements généreux. Jusqu'à 16 personnes." },
      { name: "X22", image: "https://mastercraft.com/media/ewaltwrw/my26_x22_hero_front.webp", description: "Précision et présence dans un format compact et réactif, idéal wakesurf et wakeboard. Jusqu'à 15 personnes." },
      { name: "XT24", image: "https://mastercraft.com/media/aani2yuw/xt24_26_quarter.webp", description: "Le XT le plus grand : capacité et façonnage de vague maximaux. Jusqu'à 17 personnes." },
      { name: "XT23", image: "https://mastercraft.com/media/f0cpevkn/xt23_26_quarter.webp", description: "Plateforme étendue et équipements premium pour passionnés. Jusqu'à 16 personnes." },
      { name: "XT22", image: "https://mastercraft.com/media/cbkh4kis/xt22_26_quarter.webp", description: "Le XT qui équilibre performance et capacité familiale. Jusqu'à 16 personnes." },
      { name: "XT22T", image: "https://mastercraft.com/media/ge4hbsqm/xt22t_26_quarter.webp", description: "La variante à proue pickle-fork du XT : esthétique moderne et distinctive. Jusqu'à 14 personnes." },
      { name: "XT20", image: "https://mastercraft.com/media/4zcjksyz/xt20_26_quarter.webp", description: "Le surf-boat compact et polyvalent, parfait pour débuter. Jusqu'à 12 personnes." },
      { name: "NXT24", image: "https://mastercraft.com/media/ljhdresw/nxt24_26_hero_quarter.webp", description: "Le fleuron NXT : capacité maximale et performances premium, option moteur 6.2L. Jusqu'à 16 personnes." },
      { name: "NXT23", image: "https://mastercraft.com/media/zxlbs5w4/nxt23_26_hero_quarter.webp", description: "Capacité étendue et ballast accru, option moteur 6.2L GDI. Jusqu'à 16 personnes." },
      { name: "NXT22", image: "https://mastercraft.com/media/jfwlf3oq/nxt22_26_hero_quarter.webp", description: "Le NXT polyvalent, plus de ballast pour de meilleures vagues. Jusqu'à 14 personnes." },
      { name: "NXT20", image: "https://mastercraft.com/media/gcuhlmtq/nxt20_26_hero_quarter.webp", description: "L'accès à l'univers MasterCraft dans un format 20 pieds maniable. Jusqu'à 11 personnes." },
      { name: "ProStar", image: "https://mastercraft.com/media/4ihpe2xu/my25-prostar-quarter.webp", description: "La référence absolue du ski nautique : le sillage le plus plat du marché et un suivi laser-précis. 7 personnes." },
    ],
    comparisons: [
      {
