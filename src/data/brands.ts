...
export const brandsData: Record<string, BrandData> = {
  ...
  mastercraft: {
    ...
    models: [
      { name: "XStar 23", image: "/images/placeholder-boat.jpg", description: "Le fleuron luxe de MasterCraft : proue pickle-fork iconique, vagues de classe mondiale (SurfStar) et finitions premium. Jusqu'à 16 personnes." },
      { name: "XStar 25", image: "/images/placeholder-boat.jpg", description: "La version XL du fleuron : 18 places, coque affinée et stern thruster pour une maniabilité totale (rotation 360°)." },
      { name: "X24", image: "/images/placeholder-boat.jpg", description: "Le plus grand des X : espace maximal, ballast renforcé (4 050 lbs) pour des vagues puissantes. Jusqu'à 17 personnes." },
      { name: "X23", image: "/images/placeholder-boat.jpg", description: "Le X au volume intérieur accru : assises plus profondes et rangements généreux. Jusqu'à 16 personnes." },
      { name: "X22", image: "/images/placeholder-boat.jpg", description: "Précision et présence dans un format compact et réactif, idéal wakesurf et wakeboard. Jusqu'à 15 personnes." },
      { name: "XT24", image: "/images/placeholder-boat.jpg", description: "Le XT le plus grand : capacité et façonnage de vague maximaux. Jusqu'à 17 personnes." },
      { name: "XT23", image: "/images/placeholder-boat.jpg", description: "Plateforme étendue et équipements premium pour passionnés. Jusqu'à 16 personnes." },
      { name: "XT22", image: "/images/placeholder-boat.jpg", description: "Le XT qui équilibre performance et capacité familiale. Jusqu'à 16 personnes." },
      { name: "XT22T", image: "/images/placeholder-boat.jpg", description: "La variante à proue pickle-fork du XT : esthétique moderne et distinctive. Jusqu'à 14 personnes." },
      { name: "XT20", image: "/images/placeholder-boat.jpg", description: "Le surf-boat compact et polyvalent, parfait pour débuter. Jusqu'à 12 personnes." },
      { name: "NXT24", image: "/images/placeholder-boat.jpg", description: "Le fleuron NXT : capacité maximale et performances premium, option moteur 6.2L. Jusqu'à 16 personnes." },
      { name: "NXT23", image: "/images/placeholder-boat.jpg", description: "Capacité étendue et ballast accru, option moteur 6.2L GDI. Jusqu'à 16 personnes." },
      { name: "NXT22", image: "/images/placeholder-boat.jpg", description: "Le NXT polyvalent, plus de ballast pour de meilleures vagues. Jusqu'à 14 personnes." },
      { name: "NXT20", image: "/images/placeholder-boat.jpg", description: "L'accès à l'univers MasterCraft dans un format 20 pieds maniable. Jusqu'à 11 personnes." },
      { name: "ProStar", image: "/images/placeholder-boat.jpg", description: "La référence absolue du ski nautique : le sillage le plus plat du marché et un suivi laser-précis. 7 personnes." },
    ],
    comparisons: [
      {
