...
export const brandsData: Record<string, BrandData> = {
  nautique: {
    ...
    name: "Nautique",
    fullName: "Nautique",
    logo: "https://i.postimg.cc/76j3dyps/nautique-web-logo-white.png",
    ...
    models: [
      ...
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1544526226-d4568010ff7a?auto=format&fit=crop&q=80&w=800",
      ...
      },
      {
        ...
        image: "https://i.postimg.cc/rF8Vf3ST/26723-16656744.webp",
    ...
    comparisons: [
      {
        ...
        specs: [
          ...
          { label: "Faisceau", values: ["102\" / 2.59 m", "102\" / 2.59 m"] },
          { label: "Brouillon", values: ["34\" / .86 m", "34.5\" / .88 m"] },
      ...
      },
      {
        ...
        specs: [
          ...
          { label: "Faisceau", values: ["102\" / 2.59 m", "102\" / 2.59 m"] },
          { label: "Brouillon", values: ["31\" / .79 m", "32\" / .81 m"] },
  ...
  mastercraft: {
    ...
    logo: "https://i.postimg.cc/sxMczwWh/MCFT-70e1d427.png",
    heroImage: "https://images.unsplash.com/photo-1544526226-d4568010ff7a?auto=format&fit=crop&q=80&w=1200",
    ...
    models: [
      {
        name: "XStar S",
        image: "https://images.unsplash.com/photo-1544526226-d4568010ff7a?auto=format&fit=crop&q=80&w=600",
  ...
  tige: {
    ...
    name: "Tigé",
    fullName: "Tigé Boats",
    logo: "https://i.postimg.cc/Hxd0SZKD/tigeboats-logo-black-orange-Logo.jpg",
    ...
    description: "Tigé est reconnu for sa polyvalence et son innovation constante dans la création de vagues parfaites.",
    models: []
  },
  centurion: {
    id: "centurion",
    ...
    logo: "https://i.postimg.cc/Fz1Lq2Vf/centurion-boats-logo-png-seeklogo-387911.png",
  ...
  supra: {
    ...
    logo: "https://i.postimg.cc/VNY5pxYs/311-3118902-supra-logo-png-transparent-supra-boats-logo-png.png",
    heroImage: "https://images.unsplash.com/photo-1590455855018-02bd3dd12fdb?auto=format&fit=crop&q=80&w=1200",
  ...
  moomba: {
    ...
    logo: "https://i.postimg.cc/bwR1ZHrH/moomba-roo-logo-Bf-Vrq-X3V.jpg",
    heroImage: "https://images.unsplash.com/photo-1520699432652-3d964cbac30e?auto=format&fit=crop&q=80&w=1200",
  ...
  axis: {
    ...
    logo: "https://i.postimg.cc/FKBdSP4b/header-logo.png",
    heroImage: "https://images.unsplash.com/photo-1510313063065-2fb7d37bf1a5?auto=format&fit=crop&q=80&w=1200",
