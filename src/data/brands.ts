...
export const STATIC_BRANDS_DATA: Record<string, BrandData> = {
  ...
  mastercraft: {
    ...
    heroWordmark: true,
    heroImage: "/images/imported/iujfrvnt-dt-background-image-1.webp",
    tagline: "Une exigence sans compromis",
    introImages: [
      "/images/imported/cwehmhdl-mb-2-3.webp",
      "/images/imported/0zadabm5-mb-1-3.webp",
      "/images/imported/oneinmeq-mb-gal-1.webp",
      "/images/imported/kinb2meu-mb-2-3.webp",
      "/images/imported/escgkxei-mb-1-1.webp",
      "/images/imported/0zrehkiw-mb-built-for-better-waves.webp",
    ],
    ...
    models: [
      { name: "XStar 23", image: "/images/imported/0zadabm5-mb-1-3.webp", description: "Le fleuron luxe de MasterCraft : proue pickle-fork iconique, vagues de classe mondiale (SurfStar) et finitions premium. Jusqu'à 16 personnes." },
      { name: "XStar 25", image: "/images/imported/fm3nab5i-mb-1-4.webp", description: "La version XL du fleuron : 18 places, coque affinée et stern thruster pour une maniabilité totale (rotation 360°)." },
      { name: "X24", image: "/images/imported/cwehmhdl-mb-2-3.webp", description: "Le plus grand des X : espace maximal, ballast renforcé (4 050 lbs) pour des vagues puissantes. Jusqu'à 17 personnes." },
      { name: "X23", image: "/images/imported/oneinmeq-mb-gal-1.webp", description: "Le X au volume intérieur accru : assises plus profondes et rangements généreux. Jusqu'à 16 personnes." },
      { name: "X22", image: "/images/imported/0zrehkiw-mb-built-for-better-waves.webp", description: "Précision et présence dans un format compact et réactif, idéal wakesurf et wakeboard. Jusqu'à 15 personnes." },
      { name: "XT24", image: "/images/imported/kinb2meu-mb-2-3.webp", description: "Le XT le plus grand : capacité et façonnage de vague maximaux. Jusqu'à 17 personnes." },
      { name: "XT23", image: "/images/imported/m20l1ob4-mb-driving.webp", description: "Plateforme étendue et équipements premium pour passionnés. Jusqu'à 16 personnes." },
      { name: "XT22", image: "/images/imported/0p4bxnoq-mb-3-3.webp", description: "Le XT qui équilibre performance et capacité familiale. Jusqu'à 16 personnes." },
      { name: "XT22T", image: "/images/imported/1wehzsnp-mb-3-3.webp", description: "La variante à proue pickle-fork du XT : esthétique moderne et distinctive. Jusqu'à 14 personnes." },
      { name: "XT20", image: "/images/imported/1d2asqo0-mb-1-3.webp", description: "Le surf-boat compact et polyvalent, parfait pour débuter. Jusqu'à 12 personnes." },
      { name: "NXT24", image: "/images/imported/escgkxei-mb-1-1.webp", description: "Le fleuron NXT : capacité maximale et performances premium, option moteur 6.2L. Jusqu'à 16 personnes." },
      { name: "NXT23", image: "/images/imported/2kul0ct5-mb-1-1.webp", description: "Capacité étendue et ballast accru, option moteur 6.2L GDI. Jusqu'à 16 personnes." },
      { name: "NXT22", image: "/images/imported/vtzbitju-mb-1.webp", description: "Le NXT polyvalent, plus de ballast pour de meilleures vagues. Jusqu'à 14 personnes." },
      { name: "NXT20", image: "/images/imported/4bykamyl-mb-1.webp", description: "L'accès à l'univers MasterCraft dans un format 20 pieds maniable. Jusqu'à 11 personnes." },
      { name: "ProStar", image: "/images/imported/szgbgc4i-wake-desktop.webp", description: "La référence absolue du ski nautique : le sillage le plus plat du marché et un suivi laser-précis. 7 personnes." },
    ],
    comparisons: [
      {
