...
const STATIC_CITIES: Record<string, HivernageCity> = {
  "annecy": {
    ...
    "city": "Annecy",
    "h1": "Hivernage et stockage de bateau à Annecy",
    "metaTitle": "Hivernage bateau Annecy — Sortie avant les gelées",
    "metaDescription": "Protégez votre bateau à Annecy avec Motor Boat 74. Hivernage intérieur, stockage sécurisé et entretien complet, proche du lac d’Annecy.",
    "hero": "/images/hivernage/annecy.webp",
    "intro": "Protégez votre bateau durant la saison hivernale avec notre service complet d'hivernage à Annecy. Chez Motor Boat 74, nous proposons des solutions de stockage sécurisées, intérieures ou extérieures, adaptées à tous types d'embarcations, à proximité immédiate du lac d'Annecy.",
    "lake": "lac d'Annecy",
  ...
  "aix-les-bains": {
    ...
    "city": "Aix-les-Bains",
    "h1": "Hivernage de bateau à Aix-les-Bains et sur le lac du Bourget",
    "metaTitle": "Hivernage bateau Aix-les-Bains, lac du Bourget",
    "metaDescription": "Protégez votre bateau à Aix-les-Bains avec Motor Boat 74. Hivernage intérieur, stockage sécurisé et entretien complet, proche du Lac du Bourget.",
    "hero": "/images/hivernage/aix-les-bains.webp",
    "intro": "Nous prenons en charge votre bateau sur le lac du Bourget pour l’hiver grâce à notre service complet d’hivernage. Motor Boat 74 assure le transport et le stockage sécurisé en intérieur, avec un entretien adapté à tous types d’embarcations, pour que votre bateau reste parfaitement protégé tout au long de la saison hivernale.",
    "lake": "lac du Bourget",
  ...
  "evian-les-bains": {
    ...
    "h1": "Hivernage de bateau à Évian et sur le Haut-Lac",
    "metaTitle": "Hivernage bateau Évian — Léman, eau calcaire",
    "metaDescription": "Protégez votre bateau à Évian-les-Bains avec Motor Boat 74. Hivernage intérieur, stockage sécurisé et entretien complet, proche du lac Léman.",
  ...
  "thonon-les-bains": {
    ...
    "h1": "Hivernage de bateau à Thonon et dans le Chablais",
    "metaTitle": "Hivernage bateau Thonon — Port de Rives, Séchex",
    "metaDescription": "Protégez votre bateau à Thonon-les-Bains avec Motor Boat 74. Hivernage intérieur, stockage sécurisé et entretien complet, proche du lac Léman.",
  ...
  "geneve": {
    ...
    "city": "Genève",
    "h1": "Hivernage de bateau à Genève et sur le Petit Lac",
    "metaTitle": "Hivernage bateau Genève — Passage de frontière",
    "metaDescription": "Protégez votre bateau à Genève avec Motor Boat 74. Hivernage intérieur, stockage sécurisé et entretien complet, proche du lac Léman.",
    "hero": "/images/hivernage/geneve.webp",
    "intro": "Profitez de notre service complet d’hivernage pour votre bateau à Genève sur le lac Léman. Motor Boat 74 se charge du transport sécurisé et du stockage en intérieur, avec un entretien sur mesure pour tous types d’embarcations, afin de garantir à votre bateau une protection optimale tout au long de l’hiver.",
    "lake": "Lac Léman",
  ...
  "lac-de-serre-poncon": {
    ...
    "h1": "Hivernage de bateau au lac de Serre-Ponçon",
    "metaTitle": "Hivernage bateau Serre-Ponçon — Avant le marnage",
    "metaDescription": "Hivernez votre bateau au Lac de Serre-Ponçon avec Motor Boat 74. Hivernage intérieur, stockage sécurisé et entretien complet.",
    "hero": "/images/hivernage/lac-de-serre-poncon.webp",
    "intro": "Profitez de notre service complet d’hivernage pour votre bateau au Lac de Serre-Ponçon. Motor Boat 74 se charge du transport sécurisé et du stockage en intérieur, avec un entretien sur mesure pour tous types d’embarcations, afin de garantir à votre bateau une protection optimale tout au long de l’hiver.",
