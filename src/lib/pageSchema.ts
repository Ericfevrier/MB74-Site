      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'partners.title', label: 'Titre', type: 'text', default: 'Ils nous font confiance' },
          {
            ...
            defaultList: [
              { name: 'Nautique', logo: '/images/partners/nautique.webp', url: '/marque/nautique' },
              { name: 'Connelly', logo: '/images/partners/connelly.webp', url: '' },
              { name: 'Vanclaes', logo: '/images/partners/vanclaes.webp', url: '' },
              { name: 'PCM Marine', logo: '/images/partners/pcm.webp', url: '' },
              { name: 'Sports Service', logo: '/images/partners/sports-service.webp', url: '' },
            ],
          },
        ],
      },
